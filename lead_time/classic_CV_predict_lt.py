from sf_runoff_lt import create_it_matrix_lt, create_gap
...
def classic_CV_SVR_predict(daily_input, C, eps, t_length,t_unit, n_splits,lt):#, radius_for_ensemble):
    ...
    it_matrix=create_it_matrix_lt(daily_input,t_length,t_unit)
...
def classic_CV_PCA_SVR_predict(daily_input, C, eps, n, t_length,t_unit ,n_splits,lt): #radius_for_ensemble):
